...
describe('most liked', () => {
  ...
  test('when list zero blogs', () => {
    const result = listHelper.mostLiked(zeroBlogs);
    expect(result).toEqual(undefined);
  });

  test('when list has one blog', () => {
    const result = listHelper.mostLiked(oneBlog);
    expect(result.title).toEqual('React patterns');
  });

  test('when list many blogs', () => {
    const result = listHelper.mostLiked(manyBlogs);
